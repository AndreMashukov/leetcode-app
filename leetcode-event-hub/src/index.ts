// Placeholder entrypoint for leetcode-event-hub.
//
...
export const EVENT_HUB_STACK_NAME = "leetcode-event-hub";
export const EVENT_HUB_STACK_DESCRIPTION =
  "EventBridge bus + archive; shared by every other stack in the leetcode system";
